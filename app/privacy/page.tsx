        ...
        <section>
          ...
          <Table
            ...
            rows={[
              ...
              [
                "푸시 알림 토큰, 앱 버전, 알림용 내 구단주명·즐겨찾기 구단주명",
                "iOS 앱에서 알림을 허용한 경우",
                "주간 성적표·메타 요약·내 글 새 댓글 알림 발송",
              ],
              [
                "스쿼드 배틀 투표 중복 방지값(회원 ID 또는 IP·기기 식별자를 합쳐 만든 해시값, 원본 미저장)",
                "스쿼드 배틀 투표 시",
                "중복 투표 방지",
              ],
              [
          ...
          <p className="mt-3 text-muted">
            ...
            이용자 기기(브라우저·앱 저장소)에만 저장되며 서버로 전송되지 않습니다. 단, iOS 앱에서 알림을 허용하면 알림을
            보내기 위해 내 구단주명과 즐겨찾기 구단주명이 알림 토큰과 함께 서버에 저장됩니다.
          </p>
        </section>
        ...
        <section>
          ...
          <Table
            ...
            rows={[
              ...
              ["알림", "선택", "주간 성적표·메타 요약·내 글 새 댓글 알림. 거부해도 다른 기능은 동일하게 이용할 수 있습니다."],
              ["사진 추가(저장 전용)", "선택", "공유 카드를 사진 앱에 저장할 때만 요청합니다. 사진 보관함을 읽지 않습니다."],
              ["카메라·위치·연락처·마이크", "요청하지 않음", "—"],
            ]}
          />
          <p className="mt-2 text-muted">
            카드 이미지는 iOS 공유 시트로 공유하며, 공유 시트에서 &quot;이미지 저장&quot;을 누를 때만 사진 추가 권한을 요청합니다. 권한은 iOS
        ...
        <section>
          ...
          <Table
            ...
            rows={[
              ...
              ["푸시 알림 토큰·알림용 구단주명", "알림을 끄거나 앱을 삭제해 토큰이 무효가 되면 삭제(발송 실패 시 자동 정리)"],
              ["투표 중복 방지값(해시)", "해당 투표가 속한 게시물·비교가 운영되는 동안(원본 식별자는 저장하지 않음)"],
