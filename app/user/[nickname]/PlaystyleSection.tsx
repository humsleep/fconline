      ...
      <section className="panel relative overflow-hidden p-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {result.controller !== "unknown" && (
            <span className="rounded bg-surface-2 px-2 py-0.5 text-[12px] text-muted">
      ...
      {result.chips.length > 0 && (
        <section className="mt-3 grid gap-2 sm:grid-cols-2">
          <div className="panel p-4">
            <p className="text-[12px] font-semibold text-win">강점</p>
            <ul className="mt-2 space-y-1.5">
              ...
              {result.chips.every((c) => c.kind !== "strength") && (
                <li className="text-[13px] text-muted">두드러진 강점 데이터 없음</li>
              )}
            </ul>
          </div>
          <div className="panel p-4">
            <p className="text-[12px] font-semibold text-lose">취약</p>
            <ul className="mt-2 space-y-1.5">
              ...
              {result.chips.every((c) => c.kind !== "weakness") && (
                <li className="text-[13px] text-muted">두드러진 취약점 없음 — 안정적</li>
              )}
            </ul>
          </div>
        </section>
