        ...
        {sessionMatches.length === 0 ? (
          ...
          <div className="mt-2 flex flex-wrap items-center gap-x-8 gap-y-3">
            <div>
              ...
              <p className="text-[10px] text-muted">세션 전적</p>
            </div>
            {rec.streak !== 0 && (
              <div>
                <p
                ...
                <p className="text-[10px] text-muted">현재 흐름</p>
              </div>
            )}
            <div>
              ...
              <p className="text-[10px] text-muted">득실</p>
            </div>
            <div className="min-w-28">
              <Sparkline values={[...sessionMatches].reverse().map((m) => m.me.rating)} />
              <p className="text-[10px] text-muted">평점 추이</p>
            </div>
          </div>
        )}
      </section>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-[11px] text-muted">{formatMatchDate(m.matchDate)}</p>
      </div>
